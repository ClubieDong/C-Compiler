// Generated by Bisonc++ V6.03.00 on Sun, 03 Jan 2021 21:08:26 +0800
...
PI_ const s_productionInfo[] = 
{
     ...
     {284, 2}, // 48: VarDecl (PTR) ->  '&' VarDecl
     {284, 3}, // 49: VarDecl ('(') ->  '(' VarDecl ')'
     {284, 3}, // 50: VarDecl ('(') ->  '(' errTok_ ')'
     {285, 4}, // 51: FuncDecl ('(') ->  ID '(' OptParamList ')'
     {285, 3}, // 52: FuncDecl (ARR) ->  FuncDecl '[' ']'
     {285, 4}, // 53: FuncDecl (ARR) ->  FuncDecl '[' Expression ']'
     {285, 4}, // 54: FuncDecl (ARR) ->  FuncDecl '[' errTok_ ']'
     {285, 2}, // 55: FuncDecl (PTR) ->  '*' FuncDecl
     {285, 2}, // 56: FuncDecl (PTR) ->  '&' FuncDecl
     {285, 3}, // 57: FuncDecl ('(') ->  '(' FuncDecl ')'
     {285, 3}, // 58: FuncDecl ('(') ->  '(' errTok_ ')'
     {287, 0}, // 59: EmptyID ->  <empty>
     {288, 1}, // 60: PureDecl ->  EmptyID
     {288, 4}, // 61: PureDecl ('(') ->  EmptyID '(' OptParamList ')'
     {288, 3}, // 62: PureDecl (ARR) ->  Decl '[' ']'
     {288, 4}, // 63: PureDecl (ARR) ->  Decl '[' Expression ']'
     {288, 4}, // 64: PureDecl (ARR) ->  Decl '[' errTok_ ']'
     {288, 2}, // 65: PureDecl (PTR) ->  '*' Decl
     {288, 2}, // 66: PureDecl (PTR) ->  '&' Decl
     {288, 3}, // 67: PureDecl ('(') ->  '(' Decl ')'
     {288, 3}, // 68: PureDecl ('(') ->  '(' errTok_ ')'
     {289, 1}, // 69: Decl ->  VarDecl
     {289, 1}, // 70: Decl ->  FuncDecl
     {290, 1}, // 71: InitDecl ->  Decl
     {290, 3}, // 72: InitDecl ('=') ->  Decl '=' Expression
     {291, 1}, // 73: TypePrimitive (VOID) ->  VOID
     {291, 1}, // 74: TypePrimitive (INT) ->  INT
     {291, 2}, // 75: TypePrimitive (STRUCT) ->  STRUCT ID
     {292, 1}, // 76: DeclList ->  InitDecl
     {292, 3}, // 77: DeclList (',') ->  DeclList ',' InitDecl
     {292, 3}, // 78: DeclList (',') ->  DeclList ',' errTok_
     {286, 0}, // 79: OptParamList ->  <empty>
     {286, 1}, // 80: OptParamList (VOID) ->  VOID
     {286, 1}, // 81: OptParamList ->  ParamList
     {293, 2}, // 82: ParamList ->  TypePrimitive Decl
     {293, 4}, // 83: ParamList (',') ->  ParamList ',' TypePrimitive Decl
     {293, 3}, // 84: ParamList (',') ->  ParamList ',' errTok_
     {281, 3}, // 85: Declaration (';') ->  TypePrimitive DeclList ';'
     {281, 5}, // 86: Declaration ('{') ->  TypePrimitive FuncDecl '{' StatementList '}'
     {281, 5}, // 87: Declaration ('{') ->  TypePrimitive FuncDecl '{' errTok_ '}'
     {273, 1}, // 88: DeclarationList ->  Declaration
     {273, 2}, // 89: DeclarationList ->  DeclarationList Declaration
     {273, 2}, // 90: DeclarationList (errTok_) ->  DeclarationList errTok_
     {294, 1}, // 91: Program_$ ->  Program
};
...
SR_ s_24[] =
{
    ...
    { {     276}, { 41} }, // Expression       
    { { errTok_}, { 42} }, // errTok_          
    { {     279}, { 43} }, // PreExpression    
    { {     277}, { 44} }, // PostExpression   
    { {      45}, { 45} }, // '-'              
    { {     275}, { 46} }, // PrimaryExpression
    { {     264}, { 47} }, // NUM              
    { {     274}, { 48} }, // ID               
    { {      40}, { 49} }, // '('              
    { {     265}, { 18} }, // ID_TEXT          
