// Generated by Bisonc++ V6.03.00 on Tue, 29 Dec 2020 12:17:54 +0800
...
PI_ const s_productionInfo[] = 
{
     ...
     {270, 1}, // 1: Program ->  StatementList
     {272, 1}, // 2: Expression (NUM) ->  NUM
     {272, 1}, // 3: Expression (ID) ->  ID
     {272, 3}, // 4: Expression ('=') ->  Expression '=' Expression
     {272, 3}, // 5: Expression ('<') ->  Expression '<' Expression
     {272, 3}, // 6: Expression ('>') ->  Expression '>' Expression
     {272, 3}, // 7: Expression (LE) ->  Expression LE Expression
     {272, 3}, // 8: Expression (GE) ->  Expression GE Expression
     {272, 3}, // 9: Expression (EQ) ->  Expression EQ Expression
     {272, 3}, // 10: Expression (NE) ->  Expression NE Expression
     {272, 3}, // 11: Expression ('+') ->  Expression '+' Expression
     {272, 3}, // 12: Expression ('-') ->  Expression '-' Expression
     {272, 3}, // 13: Expression ('*') ->  Expression '*' Expression
     {272, 3}, // 14: Expression ('/') ->  Expression '/' Expression
     {272, 2}, // 15: Expression (NEG) ->  '-' Expression
     {272, 4}, // 16: Expression ('(') ->  Expression '(' OptArgList ')'
     {272, 3}, // 17: Expression ('(') ->  '(' Expression ')'
     {274, 1}, // 18: Statement (';') ->  ';'
     {274, 2}, // 19: Statement (';') ->  Expression ';'
     {274, 5}, // 20: Statement (IF) ->  IF '(' Expression ')' Statement
     {274, 7}, // 21: Statement (IF) ->  IF '(' Expression ')' Statement ELSE Statement
     {274, 5}, // 22: Statement (WHILE) ->  WHILE '(' Expression ')' Statement
     {274, 2}, // 23: Statement (RETURN) ->  RETURN ';'
     {274, 3}, // 24: Statement (RETURN) ->  RETURN Expression ';'
     {274, 3}, // 25: Statement ('{') ->  '{' StatementList '}'
     {271, 0}, // 26: StatementList ->  <empty>
     {271, 2}, // 27: StatementList ->  StatementList Statement
     {273, 0}, // 28: OptArgList ->  <empty>
     {273, 1}, // 29: OptArgList ->  ArgList
     {275, 1}, // 30: ArgList ->  Expression
     {275, 3}, // 31: ArgList (',') ->  ArgList ',' Expression
     {276, 1}, // 32: Program_$ ->  Program
};
...
try
{
    ...
    switch (production)
    {
        ...
        case 2:
        { d_val_ = ast::Constant::Create(std::stod(scanner.matched())); }
        break;

        case 3:
        { d_val_ = ast::Variable::Create(scanner.matched()); }
        break;
        ...
        case 16:
        { d_val_ = ast::CallExpr::Create(std::move(vs_(-3)), std::move(vs_(-1))); }
        break;
        ...
        case 30:
        { d_val_ = ast::ArgList::Create(std::move(vs_(0))); }
        break;

        case 31:
        { d_val_ = std::move(vs_(-2)); dynamic_cast<ast::ArgList*>(d_val_.get())->Add(std::move(vs_(0))); }
        break;
