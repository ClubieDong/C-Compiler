// Generated by Bisonc++ V6.03.00 on Wed, 30 Dec 2020 00:09:27 +0800
...
PI_ const s_productionInfo[] = 
{
     ...
     {281, 0}, // 26: #0001 ->  <empty>
     {280, 0}, // 27: Statement ->  <empty>
     {277, 0}, // 28: StatementList ->  <empty>
     {277, 2}, // 29: StatementList ->  StatementList Statement
     {279, 0}, // 30: OptArgList ->  <empty>
     {279, 1}, // 31: OptArgList ->  ArgList
     {282, 1}, // 32: ArgList ->  Expression
     {282, 3}, // 33: ArgList (',') ->  ArgList ',' Expression
     {283, 1}, // 34: VarDecl (NEWID) ->  NEWID
     {283, 3}, // 35: VarDecl ('(') ->  '(' DeclVar ')'
     {283, 4}, // 36: VarDecl (ARR) ->  DeclVar '[' Expression ']'
     {283, 2}, // 37: VarDecl (PTR) ->  '*' DeclVar
     {285, 1}, // 38: InitVarDecl ->  VarDecl
     {285, 3}, // 39: InitVarDecl ('=') ->  VarDecl '=' Expression
     {286, 1}, // 40: PrimitiveType (INT) ->  INT
     {286, 1}, // 41: PrimitiveType (VOID) ->  VOID
     {286, 1}, // 42: PrimitiveType (TYPEID) ->  TYPEID
     {287, 1}, // 43: Program_$ ->  Program
};
...
try
{
    ...
    switch (production)
    {
        ...
        case 2:
        { d_val_ = ast::Constant::Create(std::stod(_Scanner->matched())); }
        break;

        case 3:
        { d_val_ = ast::Variable::Create(_Scanner->matched()); }
        break;

        case 4:
        { d_val_ = ast::BiOpExpr::Create(std::move(vs_(-2)), std::move(vs_(0)), ast::BiOpExpr::ASSIGN); }
        break;

        case 5:
        { d_val_ = ast::BiOpExpr::Create(std::move(vs_(-2)), std::move(vs_(0)), ast::BiOpExpr::LESS); }
        break;

        case 6:
        { d_val_ = ast::BiOpExpr::Create(std::move(vs_(-2)), std::move(vs_(0)), ast::BiOpExpr::GREATER); }
        break;

        case 7:
        { d_val_ = ast::BiOpExpr::Create(std::move(vs_(-2)), std::move(vs_(0)), ast::BiOpExpr::LESS_EQUAL); }
        break;

        case 8:
        { d_val_ = ast::BiOpExpr::Create(std::move(vs_(-2)), std::move(vs_(0)), ast::BiOpExpr::GREATER_EQUAL); }
        break;

        case 9:
        { d_val_ = ast::BiOpExpr::Create(std::move(vs_(-2)), std::move(vs_(0)), ast::BiOpExpr::EQUAL); }
        break;

        case 10:
        { d_val_ = ast::BiOpExpr::Create(std::move(vs_(-2)), std::move(vs_(0)), ast::BiOpExpr::NOT_EQUAL); }
        break;

        case 11:
        { d_val_ = ast::BiOpExpr::Create(std::move(vs_(-2)), std::move(vs_(0)), ast::BiOpExpr::ADD); }
        break;

        case 12:
        { d_val_ = ast::BiOpExpr::Create(std::move(vs_(-2)), std::move(vs_(0)), ast::BiOpExpr::SUB); }
        break;

        case 13:
        { d_val_ = ast::BiOpExpr::Create(std::move(vs_(-2)), std::move(vs_(0)), ast::BiOpExpr::MUL); }
        break;

        case 14:
        { d_val_ = ast::BiOpExpr::Create(std::move(vs_(-2)), std::move(vs_(0)), ast::BiOpExpr::DIV); }
        break;

        case 15:
        { d_val_ = ast::UnOpExpr::Create(std::move(vs_(0)), ast::UnOpExpr::NEG); }
        break;

        case 16:
        { d_val_ = std::move(vs_(-1)); dynamic_cast<ast::CallExpr*>(d_val_.get())->SetFunc(std::move(vs_(-3))); }
        break;
        ...
        case 18:
        { d_val_ = ast::ExprStmt::Create(); }
        break;

        case 19:
        { d_val_ = ast::ExprStmt::Create(std::move(vs_(-1))); }
        break;

        case 20:
        { d_val_ = ast::IfStmt::Create(std::move(vs_(-2)), std::move(vs_(0))); }
        break;

        case 21:
        { d_val_ = ast::IfStmt::Create(std::move(vs_(-4)), std::move(vs_(-2)), std::move(vs_(0))); }
        break;

        case 22:
        { d_val_ = ast::WhileStmt::Create(std::move(vs_(-2)), std::move(vs_(0))); }
        break;

        case 23:
        { d_val_ = ast::ReturnStmt::Create(); }
        break;

        case 24:
        { d_val_ = ast::ReturnStmt::Create(std::move(vs_(-1))); }
        break;
        ...
        case 28:
        { d_val_ = ast::StatementList::Create(); }
        break;

        case 29:
        { d_val_ = std::move(vs_(-1)); dynamic_cast<ast::StatementList*>(d_val_.get())->Add(std::move(vs_(0))); }
        break;

        case 30:
        { d_val_ = ast::CallExpr::Create(); }
        break;
        ...
        case 32:
        { d_val_ = ast::CallExpr::Create(std::move(vs_(0))); }
        break;

        case 33:
        { d_val_ = std::move(vs_(-2)); dynamic_cast<ast::CallExpr*>(d_val_.get())->AddArg(std::move(vs_(0))); }
        break;
