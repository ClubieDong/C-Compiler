// Generated by Bisonc++ V6.03.00 on Sat, 02 Jan 2021 18:36:36 +0800
...
PI_ const s_productionInfo[] = 
{
     ...
     {287, 1}, // 57: Decl ->  VarDecl
     {287, 1}, // 58: Decl ->  FuncDecl
     {288, 1}, // 59: InitDecl ->  Decl
     {288, 3}, // 60: InitDecl ('=') ->  Decl '=' Expression
     {289, 1}, // 61: TypePrimitive (VOID) ->  VOID
     {289, 1}, // 62: TypePrimitive (INT) ->  INT
     {289, 2}, // 63: TypePrimitive (STRUCT) ->  STRUCT ID
     {290, 1}, // 64: DeclList ->  InitDecl
     {290, 3}, // 65: DeclList (',') ->  DeclList ',' InitDecl
     {290, 3}, // 66: DeclList (',') ->  DeclList ',' errTok_
     {286, 0}, // 67: OptParamList ->  <empty>
     {286, 1}, // 68: OptParamList (VOID) ->  VOID
     {286, 1}, // 69: OptParamList ->  ParamList
     {291, 2}, // 70: ParamList ->  TypePrimitive Decl
     {291, 4}, // 71: ParamList (',') ->  ParamList ',' TypePrimitive Decl
     {291, 3}, // 72: ParamList (',') ->  ParamList ',' errTok_
     {281, 3}, // 73: Declaration (';') ->  TypePrimitive DeclList ';'
     {281, 5}, // 74: Declaration ('{') ->  TypePrimitive FuncDecl '{' StatementList '}'
     {281, 5}, // 75: Declaration ('{') ->  TypePrimitive FuncDecl '{' errTok_ '}'
     {273, 1}, // 76: DeclarationList ->  Declaration
     {273, 2}, // 77: DeclarationList ->  DeclarationList Declaration
     {273, 2}, // 78: DeclarationList (errTok_) ->  DeclarationList errTok_
     {292, 1}, // 79: Program_$ ->  Program
};
