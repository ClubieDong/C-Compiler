// Generated by Bisonc++ V6.03.00 on Mon, 04 Jan 2021 12:49:26 +0800
...
PI_ const s_productionInfo[] = 
{
     ...
     {290, 1}, // 34: Statement (';') ->  ';'
     {290, 2}, // 35: Statement (errTok_) ->  errTok_ ';'
     {290, 2}, // 36: Statement (';') ->  Expression ';'
     {290, 1}, // 37: Statement ->  Declaration
     {290, 5}, // 38: Statement (IF) ->  IF '(' Expression ')' Statement
     {290, 7}, // 39: Statement (IF) ->  IF '(' Expression ')' Statement ELSE Statement
     {290, 5}, // 40: Statement (WHILE) ->  WHILE '(' Expression ')' Statement
     {290, 2}, // 41: Statement (RETURN) ->  RETURN ';'
     {290, 3}, // 42: Statement (RETURN) ->  RETURN Expression ';'
     {290, 3}, // 43: Statement ('{') ->  '{' StatementList '}'
     {290, 3}, // 44: Statement ('{') ->  '{' errTok_ '}'
     {292, 0}, // 45: StatementList ->  <empty>
     {292, 2}, // 46: StatementList ->  StatementList Statement
     {292, 2}, // 47: StatementList (errTok_) ->  StatementList errTok_
     {288, 0}, // 48: OptArgList ->  <empty>
     {288, 1}, // 49: OptArgList ->  ArgList
     {293, 1}, // 50: ArgList ->  Expression
     {293, 3}, // 51: ArgList (',') ->  ArgList ',' Expression
     {293, 3}, // 52: ArgList (',') ->  ArgList ',' errTok_
     {294, 1}, // 53: PrimaryVarDecl ->  ID
     {294, 3}, // 54: PrimaryVarDecl ('(') ->  '(' VarDecl ')'
     {294, 3}, // 55: PrimaryVarDecl ('(') ->  '(' errTok_ ')'
     {296, 1}, // 56: PostVarDecl ->  PrimaryVarDecl
     {296, 3}, // 57: PostVarDecl ('[') ->  PostVarDecl '[' ']'
     {296, 4}, // 58: PostVarDecl ('[') ->  PostVarDecl '[' Expression ']'
     {296, 4}, // 59: PostVarDecl ('[') ->  PostVarDecl '[' errTok_ ']'
     {295, 1}, // 60: VarDecl ->  PostVarDecl
     {295, 2}, // 61: VarDecl ('*') ->  '*' VarDecl
     {295, 2}, // 62: VarDecl ('&') ->  '&' VarDecl
     {297, 4}, // 63: PrimaryFuncDecl ('(') ->  ID '(' OptParamList ')'
     {297, 3}, // 64: PrimaryFuncDecl ('(') ->  '(' FuncDecl ')'
     {297, 3}, // 65: PrimaryFuncDecl ('(') ->  '(' errTok_ ')'
     {300, 1}, // 66: PostFuncDecl ->  PrimaryFuncDecl
     {300, 3}, // 67: PostFuncDecl ('[') ->  PostFuncDecl '[' ']'
     {300, 4}, // 68: PostFuncDecl ('[') ->  PostFuncDecl '[' Expression ']'
     {300, 4}, // 69: PostFuncDecl ('[') ->  PostFuncDecl '[' errTok_ ']'
     {299, 1}, // 70: FuncDecl ->  PostFuncDecl
     {299, 2}, // 71: FuncDecl ('*') ->  '*' FuncDecl
     {299, 2}, // 72: FuncDecl ('&') ->  '&' FuncDecl
     {301, 1}, // 73: Decl ->  VarDecl
     {301, 1}, // 74: Decl ->  FuncDecl
     {302, 1}, // 75: InitDecl ->  Decl
     {302, 3}, // 76: InitDecl ('=') ->  Decl '=' Expression
     {303, 1}, // 77: TypePrimitive (VOID) ->  VOID
     {303, 1}, // 78: TypePrimitive (BOOL) ->  BOOL
     {303, 1}, // 79: TypePrimitive (CHAR) ->  CHAR
     {303, 1}, // 80: TypePrimitive (SHORT) ->  SHORT
     {303, 1}, // 81: TypePrimitive (INT) ->  INT
     {303, 1}, // 82: TypePrimitive (LONG) ->  LONG
     {303, 1}, // 83: TypePrimitive (FLOAT) ->  FLOAT
     {303, 1}, // 84: TypePrimitive (DOUBLE) ->  DOUBLE
     {303, 2}, // 85: TypePrimitive (STRUCT) ->  STRUCT ID
     {304, 1}, // 86: DeclList ->  InitDecl
     {304, 3}, // 87: DeclList (',') ->  DeclList ',' InitDecl
     {304, 3}, // 88: DeclList (',') ->  DeclList ',' errTok_
     {298, 0}, // 89: OptParamList ->  <empty>
     {298, 1}, // 90: OptParamList (VOID) ->  VOID
     {298, 1}, // 91: OptParamList ->  ParamList
     {305, 2}, // 92: ParamList ->  TypePrimitive Decl
     {305, 4}, // 93: ParamList (',') ->  ParamList ',' TypePrimitive Decl
     {305, 3}, // 94: ParamList (',') ->  ParamList ',' errTok_
     {291, 3}, // 95: Declaration (';') ->  TypePrimitive DeclList ';'
     {291, 5}, // 96: Declaration ('{') ->  TypePrimitive FuncDecl '{' StatementList '}'
     {291, 5}, // 97: Declaration ('{') ->  TypePrimitive FuncDecl '{' errTok_ '}'
     {283, 1}, // 98: DeclarationList ->  Declaration
     {283, 2}, // 99: DeclarationList ->  DeclarationList Declaration
     {283, 2}, // 100: DeclarationList (errTok_) ->  DeclarationList errTok_
     {306, 1}, // 101: Program_$ ->  Program
};
