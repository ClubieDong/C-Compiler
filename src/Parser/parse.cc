// Generated by Bisonc++ V6.03.00 on Sun, 03 Jan 2021 22:42:46 +0800
...
try
{
    ...
    switch (production)
    {
        ...
        case 3:
        { d_val_ = std::make_unique<ast::Constant>(true); }
        break;

        case 4:
        { d_val_ = std::make_unique<ast::Constant>(false); }
        break;

        case 5:
        { d_val_ = std::make_unique<ast::Constant>(std::stoll(_Scanner->matched())); }
        break;

        case 6:
        { d_val_ = std::make_unique<ast::Constant>(std::stoll(_Scanner->matched(), nullptr, 2)); }
        break;

        case 7:
        { d_val_ = std::make_unique<ast::Constant>(std::stoll(_Scanner->matched(), nullptr, 8)); }
        break;

        case 8:
        { d_val_ = std::make_unique<ast::Constant>(std::stoll(_Scanner->matched(), nullptr, 16)); }
        break;
