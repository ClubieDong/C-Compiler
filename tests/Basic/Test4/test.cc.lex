...
DIV_ASSIGN             /=        20        11        13
 ...
 CONSTCHAR            '0'        32        26        29
   ...
   ID_TEXT              j        41        12        13
      CHAR              ;        41        13        14
       INT            int        42         2         5
   ID_TEXT          array        42         6        11
      CHAR              [        42        11        12
  CONSTINT             50        42        12        14
      CHAR              ]        42        14        15
      CHAR              ;        42        15        16
   ID_TEXT              i        44         2         3
      CHAR              =        44         3         4
  ...
  CONSTINT              0        47         5         6
   ...
   ID_TEXT              j        48        10        11
      CHAR              <        48        12        13
  CONSTINT             10        48        14        16
      CHAR              )        48        16        17
      CHAR              {        49         3         4
   ID_TEXT          array        50         4         9
      CHAR              [        50         9        10
   ID_TEXT              j        50        10        11
      CHAR              +        50        11        12
   ID_TEXT              i        50        12        13
      CHAR              *        50        13        14
  CONSTINT             10        50        14        16
      CHAR              ]        50        16        17
      CHAR              =        50        18        19
      CHAR              (        50        20        21
   ID_TEXT              i        50        21        22
      CHAR              *        50        22        23
  CONSTINT             10        50        23        25
      CHAR              +        50        25        26
   ID_TEXT              j        50        26        27
      CHAR              )        50        27        28
      CHAR              *        50        28        29
  ...
  CONSTINT              0        56        10        11
   ...
   ID_TEXT              i        57        15        16
      CHAR              <        57        17        18
  CONSTINT             50        57        19        21
      CHAR              )        57        21        22
      CHAR              {        58         8         9
   ID_TEXT         output        59        10        16
      CHAR              (        59        16        17
   ID_TEXT          array        59        17        22
      CHAR              [        59        22        23
   ID_TEXT              i        59        23        24
      CHAR              ]        59        24        25
      CHAR              )        59        25        26
